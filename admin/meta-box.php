...
<table class="form-table">
	<tbody>
		<tr>
			<th scope="row">
				<label for="pronamic_company_contact"><?php esc_html_e( 'Contact', 'pronamic_companies' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="col" colspan="2">
				<h4 class="title"><?php esc_html_e( 'Addresses', 'pronamic_companies' ); ?></h3>
			</th>
		</tr>
		<tr>
			<th scope="row">
				<label for="pronamic_company_address"><?php esc_html_e( 'Visiting Address', 'pronamic_companies' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="pronamic_company_address"><?php esc_html_e( 'Mailing Address', 'pronamic_companies' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="pronamic_company_kvk_establishment"><?php esc_html_e( 'Chamber of Commerce Number', 'pronamic_companies' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="pronamic_company_tax_number"><?php esc_html_e( 'Tax Number', 'pronamic_companies' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="col" colspan="2">
				<h4 class="title"><?php esc_html_e( 'Phone', 'pronamic_companies' ); ?></h3>
			</th>
		</tr>
		<tr>
			<th scope="row">
				<label for="pronamic_company_phone_number"><?php esc_html_e( 'Phone Number', 'pronamic_companies' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="pronamic_company_fax_number"><?php esc_html_e( 'Fax Number', 'pronamic_companies' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="col" colspan="2">
				<h4 class="title"><?php esc_html_e( 'Online', 'pronamic_companies' ); ?></h3>
			</th>
		</tr>

		<tr>
			<th scope="row">
				<label for="pronamic_company_email"><?php esc_html_e( 'E-mail Address', 'pronamic_companies' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="pronamic_company_website"><?php esc_html_e( 'Website URL', 'pronamic_companies' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="pronamic_company_rss"><?php esc_html_e( 'RSS URL', 'pronamic_companies' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="pronamic_company_video"><?php esc_html_e( 'Video URL', 'pronamic_companies' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="col" colspan="2">
				<h4 class="title"><?php esc_html_e( 'Social Networks', 'pronamic_companies' ); ?></h3>
			</th>
		</tr>

		<tr>
			<th scope="row">
				<label for="pronamic_company_twitter"><?php esc_html_e( 'Twitter Username', 'pronamic_companies' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="pronamic_company_facebook"><?php esc_html_e( 'Facebook URL', 'pronamic_companies' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="pronamic_company_linkedin"><?php esc_html_e( 'LinkedIN', 'pronamic_companies' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="pronamic_company_google_plus"><?php esc_html_e( 'Google+', 'pronamic_companies' ); ?></label>
			</th>
			<td>
